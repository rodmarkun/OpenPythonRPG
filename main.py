...
chara = character.Character("Chara", PLAYER_STARTING_STATUS, engine, EventDispatcher(), engine.environments["Peaceful Village"], [InventoryPlugin(), DungeonPlugin(), GearPlugin(), SimpleDialoguePlugin(), SpellPlugin(), CombatPlugin()])
interface.run(chara)